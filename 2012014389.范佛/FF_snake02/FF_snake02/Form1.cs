...
namespace FF_snake02
{
    ...
    public partial class Form1 : Form
    {
        ...
        void Create()
        {
            ...
            BufferedGraphics bg;
            bg = current.Allocate(this.CreateGraphics(), new Rectangle(0, 0, 450, 450)); //(2) 
        ...
        public void Drawplate(BufferedGraphics bg1)
        {
            Pen blackpen = new Pen(Color.Black, 2);
            Graphics graphics = bg1.Graphics;
            int i;
        ...
        void DrawOthers(BufferedGraphics bg1)
        {
            Graphics graphics = bg1.Graphics;
            int i;
